...
//		int inner1 = instanceVar;
	...
	{
		//지역 변수
		int localVar1 = 3; // JDK 1.8부터는 지역 클래스가 참조하는 변수에 컴파일러가 자동으로 final을 붙여줌
...
//			int inner3 = localVar1; //final이 붙지 않은 지역 변수는 사용 불가.
		...
		System.out.println(l.inner1);
		System.out.println(l.inner2);
		System.out.println(l.inner4);
	}
	...
	void test1()
	{
		...
		//클래스 멤버는 클래스를 통해서 바로 접근할 수 있는것과 같이 스태틱 클래스는 클래스를 통해서 바로 접근할 수 있다.
