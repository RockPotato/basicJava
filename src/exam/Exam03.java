		 ...
		 /*[3-1] 다음 연산의 결과를 적으시오.
			...
			셋째자리에서 반올림해야한다.(Math.round()를 사용하지 않고 처리할 것)
				[연습문제]/ch3/Exercise3_7.java
					class Exercise3_7 {
						public static void main(String[] args) {
							int fahrenheit = 100;
							float celcius = (  ((5/9 * (fahrenheit - 32))*100f+0.5f)/100f  );
				...
				Fahrenheit:100
				Celcius:37.78	
			답 : ((int)((5f/9f * (fahrenheit - 32f))*100+0.5f))/100f
			...
			[연습문제]/ch3/Exercise3_9.java
				class Exercise3_9 {
					public static void main(String[] args) {
						char ch = 'z';
						boolean b = (  ((64 < ch)&&(ch<91)) ||(96<ch)&&(ch<123)||(47<ch)&&(ch<58) ? true : false  );
						System.out.println(b);
					}
				}
				[실행결과]
				true 
			답 : ((64 < ch)&&(ch<91)) ||(96<ch)&&(ch<123)||(47<ch)&&(ch<58) ? true : false
