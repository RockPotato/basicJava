...
public class Exam04 
{
	public static void main(String[] args) 
	{
		...
		답 : public static void main(String[] args) {
			   	int cnt=0;
				for(int i1=0;i1<=8;i1+=3)
				{
					for(int i=1;i<=3;i++)
					{
						for(int j=2+i1;j<=4+i1;j++)
						{
							if(j!=10)
							{
		...
		12o34는 숫자가 아닙니다.
		답 :
			if(((int)value.charAt(i)>48)&&((int)value.charAt(i)<58))
			{
				isNumber=true;
			}			
			else
