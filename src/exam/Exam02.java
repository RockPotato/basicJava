...
public class Exam02 {
	...
	public static void main(String[] args) {
		 ...
		 *
		 *	[2-6] 다음 중 키워드가 아닌 것은 모두 고르시오 ?(b,c)
		 *			a. if
		 *			b. True
		 *			c. NULL
		 *			d. Class
		 *			e. System
		 *
		 *	[2-7] 다음 중 변수의 이름으로 사용할 수 있는 것은 모두 고르시오 ? (a,d,g)
		 *			a. $ystem
		 *			b. channel#5
		 *			c. 7eleven
		 *			d. If
		 ...
		 *			e. i = (int)ch;
		 *
		 *	[2-10] char 타입의 변수에 저장될 수 있는 정수 값의 범위는? (0~65535)
		 * 
		 *	[2-11] 다음중 변수를 잘못 초기화 한 것은 모두 고르시오 ? (c,d,e)
		 *			a. byte b = 256;
		 *			b. char c = '';
		 *			c. char answer = 'no';
		 *			d. float f = 3.14
		 *			e. double d = 1.4e3f;
		 *
		 *	[2-12] 다음 중 메서드의 선언부로 알맞은 것은 모두 고르시오 main ? (a,d,e)
